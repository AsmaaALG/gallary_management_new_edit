...
class MyAdsRequestsScreen extends StatefulWidget {
  const MyAdsRequestsScreen({super.key});

  @override
  State<MyAdsRequestsScreen> createState() => _MyGalleryRequestsScreenState();
}

class _MyGalleryRequestsScreenState extends State<MyAdsRequestsScreen> {
  String? companyId;
