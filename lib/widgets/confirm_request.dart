// هذا الملف يحتوي على ودجت تأكيد لقبول أو رفض الطلب
// يمكنك استدعائه داخل كود إدارة الطلبات بكل سهولة
...
Future<void> confirmRequest({
  ...
  Color confirmColor = actionType == 'accept' ? Colors.green : primaryColor;
  ...
  if (confirmed == true) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          actionType == 'accept' ? 'تم قبول الطلب بنجاح' : 'تم رفض الطلب بنجاح',
          style: TextStyle(
              fontFamily: mainFont,
